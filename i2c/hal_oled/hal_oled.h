...
typedef void (*DRAWPOINT)(uint8_t,uint8_t);
...
void OLED_ShowNum(uint8_t x, uint8_t y, uint32_t num, uint8_t len, font_size_t size2);    //显示数字
...
void oled_new_config(OLED_DEV *);                                                      //添加oled设备
